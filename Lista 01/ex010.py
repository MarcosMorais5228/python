...
if(quantidade_pessoas == 0):
    ...
    if(quantidade_pessoas == 2) and ((('Marshall' == nome1) and ('Lily' == nome2)) or (('Marshall' == nome2) and ('Lily' == nome1))):
        print('Nada melhor que um casal para dar conselhos de relacionamento.')
    elif(quantidade_pessoas == 2) and ((('Marshall' == nome1) and ('Barney' == nome2)) or (('Marshall' == nome2) and ('Barney' == nome1))):
    ...
    elif(quantidade_pessoas == 4) and (('Marshall' == nome1) or ('Marshall' == nome2) or ('Marshall' == nome3) or ('Marshall' == nome4)) and (('Barney' == nome1) or ('Barney' == nome2) or ('Barney' == nome3) or ('Barney' == nome4)) and (('Lily' == nome1) or ('Lily' == nome2) or ('Lily' == nome3) or ('Lily' == nome4)) and (('Robin' == nome1) or ('Robin' == nome2) or ('Robin' == nome3) or ('Robin' == nome4)):
    ...
    if(('Barney' == nome1) or ('Barney' == nome2) or ('Barney' == nome3) or ('Barney' == nome4)) and (lugar == 'Arena de Laser Tag'):
        print('Com certeza a Arena de Laser Tag foi escolhida por influência de Barney. Se arrume Ted, é hora de botar um terno, tomar um whisky e partir pra diversão.')
    # Parei aqui
    elif(lugar == 'MacLaren’s Pub') or (('Marshall' == nome1) or ('Marshall' == nome2) or ('Marshall' == nome3) or ('Marshall' == nome4)) or (('Barney' == nome1) or ('Barney' == nome2) or ('Barney' == nome3) or ('Barney' == nome4)) or (('Lily' == nome1) or ('Lily' == nome2) or ('Lily' == nome3) or ('Lily' == nome4)) or (('Robin' == nome1) or ('Robin' == nome2) or ('Robin' == nome3) or ('Robin' == nome4)):
        print('Não tem erro, né? Estar no MacLaren’s é como estar em casa.')
    elif(lugar == 'MacLaren’s Pub') and ('Marshall' not in nome1) and ('Barney' not in nome1) and ('Lily' not in nome1) and ('Robin' not in nome1):
        print('Um lugar habitual, mas com uma galera diferente. Será estranho, mas Ted vai.')
    ...
    elif(quantidade_pessoas == 4) and ('Marshall' in nome1) and ('Barney' in nome1) and ('Lily' in nome1) and ('Robin' in nome1):
        print('- O quinteto junto consegue resolver qualquer problema!')
    elif(quantidade_pessoas == 4) and (('Marshall' not in nome1) or ('Barney' not in nome1) or ('Lily' not in nome1) or ('Robin' not in nome1)):
